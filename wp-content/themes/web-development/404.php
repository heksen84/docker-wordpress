    ...
    <div class="container notfount-cls">
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <h3><?php esc_html_e( "Блин! Страница не найдена.", 'web-development' ); ?></h3>
                <p><?php esc_html_e('Похоже, в этом месте ничего не найдено. Может быть, попробовать одну из ссылок ниже или поиск?', 'web-development'); ?></p>
                <?php get_search_form(); ?>
            </div>
